...
# #
# FIXME : webadm{.crt,.key} must be generated by the script and signed by the CA
# Please consult /opt/webadm/doc/howtos/Custom_SSL_Cert.txt to fix that
# Must be generated by salt at init
# #
